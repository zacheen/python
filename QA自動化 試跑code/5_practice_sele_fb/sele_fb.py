...
# useEmail='thomasshi@knowhow.fun'
# usePass='156zxc'
useEmail='thomas2850511@gmail.com'
usePass='thomas851208'
catch ='Cosplay'
...
# 
driver.get("http://www.facebook.com") #前往這個網址
...
write_dst = "D:\\dont_move\\fb.html"
with open(write_dst, "a",encoding="utf-8") as write_dst_f:
    page_source_soup = BeautifulSoup( driver.page_source, 'html.parser')
    # print(page_source_soup.prettify())
    write_dst_f.write(str(page_source_soup.prettify()))
